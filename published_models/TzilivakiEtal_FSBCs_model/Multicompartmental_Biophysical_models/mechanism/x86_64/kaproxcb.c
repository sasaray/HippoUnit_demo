...
#define lmin lmin_kapcb
 double lmin = 2;
#define linf linf_kapcb
 double linf = 0;
#define nmin nmin_kapcb
 double nmin = 0.1;
#define ninf ninf_kapcb
 double ninf = 0;
#define pw pw_kapcb
 double pw = -1;
...
#define tq tq_kapcb
 double tq = -40;
#define taun taun_kapcb
 double taun = 0;
#define taul taul_kapcb
 double taul = 0;
...
#define zetan zetan_kapcb
 ...
 "qq_kapcb", &qq_kapcb,
 "q10_kapcb", &q10_kapcb,
 "ninf_kapcb", &ninf_kapcb,
 "linf_kapcb", &linf_kapcb,
 "taul_kapcb", &taul_kapcb,
 "taun_kapcb", &taun_kapcb,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 10, 5);
 	...
 	ivoc_help("help ?1 kapcb /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/kaproxcb.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 65 in file kaproxcb.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
