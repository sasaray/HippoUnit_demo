...
#define Alpha Alpha_CPGLUIN
 double Alpha = 10;
#define Beta Beta_CPGLUIN
 double Beta = 0.18;
#define Cmax Cmax_CPGLUIN
 double Cmax = 1;
#define Cdur Cdur_CPGLUIN
 double Cdur = 0.3;
#define Erev Erev_CPGLUIN
 double Erev = 0;
#define Rtau Rtau_CPGLUIN
 double Rtau = 0;
#define Rinf Rinf_CPGLUIN
 double Rinf = 0;
 ...
 "Cmax_CPGLUIN", &Cmax_CPGLUIN,
 "Cdur_CPGLUIN", &Cdur_CPGLUIN,
 "Alpha_CPGLUIN", &Alpha_CPGLUIN,
 "Beta_CPGLUIN", &Beta_CPGLUIN,
 "Erev_CPGLUIN", &Erev_CPGLUIN,
 "Rinf_CPGLUIN", &Rinf_CPGLUIN,
 "Rtau_CPGLUIN", &Rtau_CPGLUIN,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 CPGLUIN /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/cpampain.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "calcium permeable AMPA receptor (used in FS interneuron models)";
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 99 in file cpampain.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
