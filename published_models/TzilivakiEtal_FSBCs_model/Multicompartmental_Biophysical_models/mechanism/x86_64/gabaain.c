...
#define Alpha Alpha_GABAain
 double Alpha = 5;
#define Beta Beta_GABAain
 double Beta = 0.18;
#define Cdur Cdur_GABAain
 double Cdur = 1;
#define Cmax Cmax_GABAain
 double Cmax = 1;
#define Erev Erev_GABAain
 double Erev = -80;
#define Rtau Rtau_GABAain
 double Rtau = 0;
#define Rinf Rinf_GABAain
 double Rinf = 0;
 ...
 "Cmax_GABAain", &Cmax_GABAain,
 "Cdur_GABAain", &Cdur_GABAain,
 "Alpha_GABAain", &Alpha_GABAain,
 "Beta_GABAain", &Beta_GABAain,
 "Erev_GABAain", &Erev_GABAain,
 "Rinf_GABAain", &Rinf_GABAain,
 "Rtau_GABAain", &Rtau_GABAain,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GABAain /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/gabaain.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 109 in file gabaain.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
