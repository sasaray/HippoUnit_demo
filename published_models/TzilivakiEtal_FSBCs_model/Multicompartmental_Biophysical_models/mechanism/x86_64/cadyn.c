...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 6, 4);
 	...
 	ivoc_help("help ?1 cadyn /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/cadyn.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 37 in file cadyn.mod:\n	SOLVE state METHOD euler\n"); nrn_complain(_p); abort_run(error);}
