...
#define hinf hinf_canin
 double hinf = 0;
#define ki ki_canin
 double ki = 0.025;
#define minf minf_canin
 double minf = 0;
#define s_inf s_inf_canin
 double s_inf = 0;
...
#define zetam zetam_canin
 ...
 "minf_canin", &minf_canin,
 "hinf_canin", &hinf_canin,
 "s_inf_canin", &s_inf_canin,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 12, 5);
 	...
 	ivoc_help("help ?1 canin /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/canin.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 69 in file canin.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
