...
#define _f_mgblock _f_mgblock_NMDAIN
#define mgblock mgblock_NMDAIN
 extern double _f_mgblock( double );
 extern double mgblock( double );
 /* declare global and static user variables */
#define Cmax Cmax_NMDAIN
 double Cmax = 1;
#define Cdur Cdur_NMDAIN
 double Cdur = 1;
#define mg mg_NMDAIN
 double mg = 1;
#define usetable usetable_NMDAIN
 double usetable = 1;
 ...
 "Cmax_NMDAIN", &Cmax_NMDAIN,
 "Cdur_NMDAIN", &Cdur_NMDAIN,
 "mg_NMDAIN", &mg_NMDAIN,
 "usetable_NMDAIN", &usetable_NMDAIN,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 NMDAIN /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/NMDAIN.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 103 in file NMDAIN.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
