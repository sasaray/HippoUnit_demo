...
extern Memb_func* memb_func;
 ...
 "setdata_kdrcb", _hoc_setdata,
 "alf_kdrcb", _hoc_alf,
 "bet_kdrcb", _hoc_bet,
 "rate_kdrcb", _hoc_rate,
 0, 0
};
#define alf alf_kdrcb
#define bet bet_kdrcb
 extern double alf( _threadargsprotocomma_ double );
 extern double bet( _threadargsprotocomma_ double );
 /* declare global and static user variables */
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gkdrbar_kdrcb", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gkdrbar_kdrcb", "mho/cm2",
 "ik_kdrcb", "mA/cm2",
 "gk_kdrcb", "mho/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 12, 5);
 	...
 	ivoc_help("help ?1 kdrcb /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/kdrcb.mod\n");
