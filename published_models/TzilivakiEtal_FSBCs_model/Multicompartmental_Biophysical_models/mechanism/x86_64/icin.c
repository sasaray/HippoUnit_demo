...
extern Memb_func* memb_func;
 ...
 "setdata_iCin", _hoc_setdata,
 "cbet_iCin", _hoc_cbet,
 "calf_iCin", _hoc_calf,
 "rate_iCin", _hoc_rate,
 0, 0
};
#define cbet cbet_iCin
#define calf calf_iCin
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 13, 6);
 	...
 	ivoc_help("help ?1 iCin /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/icin.mod\n");
