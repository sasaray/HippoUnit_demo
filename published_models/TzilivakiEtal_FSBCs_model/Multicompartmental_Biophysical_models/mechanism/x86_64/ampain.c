...
#define Alpha Alpha_GLUIN
 double Alpha = 10;
#define Beta Beta_GLUIN
 double Beta = 0.18;
#define Cmax Cmax_GLUIN
 double Cmax = 1;
#define Cdur Cdur_GLUIN
 double Cdur = 0.3;
#define Erev Erev_GLUIN
 double Erev = 0;
#define Rtau Rtau_GLUIN
 double Rtau = 0;
#define Rinf Rinf_GLUIN
 double Rinf = 0;
 ...
 "Cmax_GLUIN", &Cmax_GLUIN,
 "Cdur_GLUIN", &Cdur_GLUIN,
 "Alpha_GLUIN", &Alpha_GLUIN,
 "Beta_GLUIN", &Beta_GLUIN,
 "Erev_GLUIN", &Erev_GLUIN,
 "Rinf_GLUIN", &Rinf_GLUIN,
 "Rtau_GLUIN", &Rtau_GLUIN,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GLUIN /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/ampain.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 91 in file ampain.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
