...
extern Memb_func* memb_func;
 ...
 "setdata_IKscb", _hoc_setdata,
 "rate_IKscb", _hoc_rate,
 0, 0
};
 /* declare global and static user variables */
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gKsbar_IKscb", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gKsbar_IKscb", "mho/cm2",
 "ik_IKscb", "mA/cm2",
 "gk_IKscb", "mho/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 16, 5);
 	...
 	ivoc_help("help ?1 IKscb /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/ikscb.mod\n");
