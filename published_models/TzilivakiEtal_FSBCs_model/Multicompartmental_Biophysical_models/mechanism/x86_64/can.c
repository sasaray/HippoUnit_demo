...
#define zetam zetam_can
 ...
 "vhalfh_can", &vhalfh_can,
 "tm0_can", &tm0_can,
 "th0_can", &th0_can,
 "taumin_can", &taumin_can,
 "minf_can", &minf_can,
 "hinf_can", &hinf_can,
 "s_inf_can", &s_inf_can,
 0,0
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 12, 5);
 	...
 	ivoc_help("help ?1 can /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/can.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 69 in file can.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
