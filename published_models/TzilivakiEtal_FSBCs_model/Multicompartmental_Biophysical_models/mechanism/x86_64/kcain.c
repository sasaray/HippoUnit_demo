...
extern Memb_func* memb_func;
 ...
 "setdata_kcain", _hoc_setdata,
 "rates_kcain", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define b b_kcain
 double b = 0.008;
#define m_inf m_inf_kcain
 double m_inf = 0;
#define taumin taumin_kcain
 double taumin = 0;
#define tau_m tau_m_kcain
 double tau_m = 0;
 ...
 "m_inf_kcain", &m_inf_kcain,
 "tau_m_kcain", &tau_m_kcain,
 "taumin_kcain", &taumin_kcain,
 "b_kcain", &b_kcain,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 10, 6);
 	...
 	ivoc_help("help ?1 kcain /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/kcain.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 52 in file kcain.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
