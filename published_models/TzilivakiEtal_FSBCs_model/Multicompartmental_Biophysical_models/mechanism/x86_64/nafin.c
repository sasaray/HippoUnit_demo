...
extern Memb_func* memb_func;
 ...
 "setdata_Nafin", _hoc_setdata,
 "hbet_Nafin", _hoc_hbet,
 "half_Nafin", _hoc_half,
 "mbet_Nafin", _hoc_mbet,
 "malf_Nafin", _hoc_malf,
 "rate_Nafin", _hoc_rate,
 0, 0
};
#define hbet hbet_Nafin
#define half half_Nafin
#define mbet mbet_Nafin
#define malf malf_Nafin
 ...
 "gnafbar_Nafin", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnafbar_Nafin", "mho/cm2",
 "ina_Nafin", "mA/cm2",
 "gna_Nafin", "mho/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 14, 4);
 	...
 	ivoc_help("help ?1 Nafin /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/nafin.mod\n");
