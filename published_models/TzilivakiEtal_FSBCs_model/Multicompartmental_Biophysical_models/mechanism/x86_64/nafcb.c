...
extern Memb_func* memb_func;
 ...
 "setdata_Nafcb", _hoc_setdata,
 "hbet_Nafcb", _hoc_hbet,
 "half_Nafcb", _hoc_half,
 "mbet_Nafcb", _hoc_mbet,
 "malf_Nafcb", _hoc_malf,
 "rate_Nafcb", _hoc_rate,
 0, 0
};
#define hbet hbet_Nafcb
#define half half_Nafcb
#define mbet mbet_Nafcb
#define malf malf_Nafcb
 ...
 "gnafbar_Nafcb", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnafbar_Nafcb", "mho/cm2",
 "ina_Nafcb", "mA/cm2",
 "gna_Nafcb", "mho/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 14, 4);
 	...
 	ivoc_help("help ?1 Nafcb /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/nafcb.mod\n");
