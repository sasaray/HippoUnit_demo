...
extern Memb_func* memb_func;
 ...
 "setdata_iCcb", _hoc_setdata,
 "cbet_iCcb", _hoc_cbet,
 "calf_iCcb", _hoc_calf,
 "rate_iCcb", _hoc_rate,
 0, 0
};
#define cbet cbet_iCcb
#define calf calf_iCcb
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 13, 6);
 	...
 	ivoc_help("help ?1 iCcb /home/saray/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/mechanism/x86_64/iccb.mod\n");
